...
class ti5Motor
{
    ...
    ti5Motor(uint8_t canId,reductionRatio reductionRatio)
    {
        ...
        {
            try{
                _canDriver = new CanDriver(CANINTERFACE, CAN_RAW);
            }
        ...
        call_once(tlogInitializedFlag, []
        {
            ...
            {
                cerr << "log system init error" << e.what() << endl;
                exit(2);
            }
    ...
    bool writeParameter(parameterCodeTableSend1_2_2 parameterCode,uint16_t value1,uint16_t value2);
    bool writeParameter(parameterCodeTableSend1_4_1 parameterCode,int32_t value1,uint8_t value2);
    bool writeParameter(parameterCodeTableSend1_4_2 parameterCode,int32_t value1,uint16_t value2);
